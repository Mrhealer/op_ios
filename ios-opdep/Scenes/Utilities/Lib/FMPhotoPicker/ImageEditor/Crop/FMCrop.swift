...
public enum FMCrop: FMCroppable {
    ...
    case ratio16x9
    case ratio9x16
    case ratioCustom(width: CGFloat, height: CGFloat)
    case ratioOrigin
    case ratioSquare
    ...
    public func ratio() -> FMCropRatio? {
        ...
        case .ratioCustom(let width, let height):
            return FMCropRatio(width: width, height: height)
        default:
            return nil
        }
    }
    ...
    public func name(strings: [String: String]) -> String? {
        ...
        case .ratio3x4: return strings["editor_crop_ratio4x3"]
