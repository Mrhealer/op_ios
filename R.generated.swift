...
struct R: Rswift.Validatable {
  ...
  struct file {
    ...
    /// `bundle.url(forResource: "terms_conditions_en", withExtension: "html")`
    static func terms_conditions_enHtml(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.terms_conditions_enHtml
      return fileResource.bundle.url(forResource: fileResource)
    }
  ...
  struct nib {
    ...
    @available(*, deprecated, message: "Use UINib(resource: R.nib.informationCell) instead")
    static func informationCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.informationCell)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UINib(name: "TextViewCommon", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.textViewCommon) instead")
    static func textViewCommon(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.textViewCommon)
    }
    #endif
    ...
    static func testViewController(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.testViewController.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }
...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    ...
    struct _InformationCell: Rswift.NibResourceType {
      ...
      let name = "InformationCell"

      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> InformationCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? InformationCell
      }
    ...
    struct _TextViewCommon: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "TextViewCommon"
